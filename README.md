...
To ensure the plugin also compiles in the upcoming years a CMake build solution was created from which the Microsoft Visual Studio project is generated by using the CMake CLI.\
